...
public class IOGroovyMethods extends DefaultGroovyMethodsSupport {
    ...
    */
    ...
    static void writeUTF16BomIfRequired(final String charset, final Writer writer) throws IOException {
        writeUTF16BomIfRequired(Charset.forName(charset), writer);
    }

    static void writeUTF16BomIfRequired(final Charset charset, final Writer writer) throws IOException {
    ...
    static void writeUTF16BomIfRequired(final String charset, final OutputStream stream) throws IOException {
        writeUTF16BomIfRequired(Charset.forName(charset), stream);
    }

    static void writeUTF16BomIfRequired(final Charset charset, final OutputStream stream) throws IOException {
        if ("UTF-16BE".equals(charset.name())) {
